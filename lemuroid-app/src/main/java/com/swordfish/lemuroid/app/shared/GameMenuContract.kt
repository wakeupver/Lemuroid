...
object GameMenuContract {
    ...
    const val RESULT_PATCH_CODES_CHANGED = "RESULT_PATCH_CODES_CHANGED"
    const val EXTRA_ASPECT_RATIO_MODE = "EXTRA_ASPECT_RATIO_MODE"
    const val RESULT_ASPECT_RATIO_MODE = "RESULT_ASPECT_RATIO_MODE"
}
